...
#from .paths import OFFICIAL_GPT2_ENCODER_DIR, CUSTOM_BPE_ENCODER_DIR
from .paths import CUSTOM_BPE_ENCODER_DIR
...
OFFICIAL_GPT2_ENCODER_DIR = CUSTOM_BPE_ENCODER_DIR
